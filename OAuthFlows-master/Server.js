var express = require('express'),
    ...
    //jwt_consumer_key = '3MVG9sLbBxQYwWqtYsooV6BpvgefvQarhb2.OR_KpOCohJCI6qF5mOyRoLlucYcq142xe2vQ70FofSSx2GWx6',
    jwt_consumer_key = '3MVG98im9TK34CUXmy9m8gjXW6p_.YruH1uuRtHDyzjBBA4ZPXFi2.kn8RQCRUOilvjd7HT7oWYkS8kyRuQAl',
    //consumer_secret = '69B094D758971500FD22D71CA25A1A705073A7D82CC4FBBAFC0568A3B8F44975',
    consumer_secret = '11078FF98752D15666C1A6836517CCD795ED42316065E83B9F3BB97009598C5B',
...
app.set('port', process.env.PORT || 2208);
...
app.all('/proxy', function(req, res) {
    ...
    request({
        ...
        method: req.method,
        json: req.body,
        headers: { 'Authorization': req.header('X-Authorization'), 'Content-Type': 'application/json' },
        body: req.body
    }).pipe(res);
});
